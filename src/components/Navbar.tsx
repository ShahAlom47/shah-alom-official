...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full  z-50  duration-500 transition-all  backdrop-blur-sm  ${showShadow?" bg-blackLight  bg-opacity-80 shadow-lg shadow-backdrop":"shadow-none"}  ${
